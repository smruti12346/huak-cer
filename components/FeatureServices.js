...
const FeatureServiceArea = () => {
  ...
  useEffect(() => {
    if (isVisible) {
      ...
      startCount(100, setCount4);
      startCount(38, setCount5);
    }
  }, [isVisible]);
  ...
  return (
    ...
    >
      <div className="feature_service_box_width">
        ...
        <p className="heading">Excellent Price</p>
        <p className="numbercounter">${count4}+</p>
      </div>
      <div className="feature_service_box_width">
        <i className="icon-diploma"></i>
        <p className="heading">Certificate Of Authentication</p>
        <p className="numbercounter">{count5}+</p>
      </div>
      <div className="feature_service_box_width">
