            ...
            <div className="col-md-6 col-sm-6">
              <div className="blog_share_box mb-30">
                ...
                <div className="blog_share_details">
                  ...
                  <p>
                    Sep., 01, 2022, HUAK Testing Lab. passed the audit of
                    AliExpress, the worlds famous e-commerce service platform,
                    and became its officially recognized{" "}
                  </p>
                </div>
            ...
            <div className="col-md-6 col-sm-6">
              <div className="blog_share_box mb-30">
                ...
                <div className="blog_share_details">
                  ...
                  <h1>
                    <a href="blog-details.html">
                      Simple hack to improve A/C efficiency
                    </a>
                  </h1>
                  <p>
                    Good news: HUAK has Completed the Full Expansion of CPSC
                    Scope At present, the consumer group in the toy{" "}
                  </p>
                </div>
                {/*end .blog_share_details*/}
              </div>
            ...
            <div className="col-md-6 col-sm-6">
              <div className="blog_share_box">
                ...
                <div className="blog_share_details">
                  ...
                  <h1>
                    <a href="blog-details.html">
                      Heating and cooling safety issues
                    </a>
                  </h1>
                  <p>
                    There are many variations passages of lorem ipsum available
