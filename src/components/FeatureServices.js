  ...
  return (
    ...
    >
      <div className="feature_service_box_width">
        ...
        <p className="heading">ISO 17025</p>
      </div>
      <div className="feature_service_box_width">
        <i className="icon-diploma"></i>
        <p className="heading">Satisfaction Guarantee</p>
      </div>
      <div className="feature_service_box_width">
        <i className="icon-big_clock"></i>
        <p className="heading">Successful projects</p>
        <p className="numbercounter">{count1}+</p> {/* Updated: Display count1 */}
      </div>
      <div className="feature_service_box_width">
        <i className="icon-handshake"></i>
        <p className="heading">Happy customers</p>
        <p className="numbercounter">{count2}+</p> {/* Updated: Display count2 */}
      </div>
      <div className="feature_service_box_width">
        <i className="icon-mechanic"></i>
        <p className="heading">Year of experience</p>
        <p className="numbercounter">{count3}+</p> {/* Updated: Display count3 */}
      </div>
    </div>
  );
};
