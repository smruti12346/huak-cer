              ...
              <div className="col-md-9 col-sm-8 col-xs-12">
                <div className="header_contact text-left">
                  <ul className="hd_contact">
                    <li><i className="icon-placeholder" /> <a href="#"> 1-2F, B2 Building, Shenzhen, China</a></li>
                    <li><i className="icon-phone-call" /> <a href="#"> +86 13528437881</a></li>
                    <li><i className="icon-envelope"></i> <a href="#"> service@cer-mark.com</a></li>
                  </ul>
