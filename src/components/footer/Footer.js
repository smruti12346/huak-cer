          ...
          <div className="container">
            <div className="col-md-4 col-sm-4">
              <div className="footer_contact_width text-left">
                <p><i className="icon-placeholder" /> Address <span>1-2F, B2 Building, Junfeng Zhongcheng Zhizao Innovation Park, Heping Community, Fuhai Street, Baoan District, Shenzhen, China. </span></p>
              </div>{/*end .footer_contact_width*/}
            </div>{/*end .col-md-4*/}
            <div className="col-md-4 col-sm-4">
              <div className="footer_contact_width">
                <p><i className="icon-contact" /> Email <span><a href="mailto:service@cer-mark.com">service@cer-mark.com</a></span></p>
              </div>{/*end .footer_contact_width*/}
            </div>{/*end .col-md-4*/}
            <div className="col-md-4 col-sm-4">
              <div className="footer_contact_width text-right">
                <p><i className="icon-phone-call" /> Phone <span><a href>+86 13528437881</a></span></p>
              </div>{/*end .footer_contact_width*/}
            </div>{/*end .col-md-4*/}
          </div>{/*end .container*/}
            ...
            <div className="row">
              <div className="col-md-4 col-sm-6">
                <div className="footer_textwidget textwidget">
                  ...
                  <p>
                    At Shenzhen HUAK , We don’t just provide resi-dential and commercial heating and air conditioning services; we make people’s lives easier. Better.
                  </p>                        
