              ...
              <div className="contact-right contact_details">
                ...
                <div className="contact_location_box">
                  <div className="contact_location_map">
                    ...
                    <p>Address：1-2F, B2 Building, Junfeng Zhongcheng Zhizao Innovation Park,<br /> Heping Community, Fuhai Street,Bao'an District, Shenzhen, China </p>
                  </div>{/*end .contact_location_map*/}
                  <div className="contact_location_map contact_location_call">
                    <span className="icon-contact_call" />
                    <p>service@cer-mark.com<br />+86-755-23029901 <br/>+86-755-23029901</p>
            ...
            <div className="col-md-6">
              <div className="contact-right contact-right-style-2 responsive_mt">
                <form action="#" method="post">
                  ...
                  <textarea name="content" id="content" cols={20} rows={5} placeholder="Write message" defaultValue={""} />
